...
let sqlFunMainId = SQL.SQLName "__MainId"
...
// Should be in sync with compile* and sqlFun*
                ...
                let (maybeIdName, idColumns) =
                    ...
                    | Some idExpr ->
                        ...
                        | None ->
                            ...
                            (Some newName, Seq.singleton <| SQL.SCExpr (compileId newName, idExpr))
