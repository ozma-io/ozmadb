...
let inline raisefUserWithInner<'a, 'b, 'e when 'e :> UserException>
    (constr: (string * Exception * bool) -> 'e)
    (inner: Exception)
    : StringFormat<'a, 'b> -> 'a =
    kprintf <| fun str -> raise <| constr (str, inner, true)
