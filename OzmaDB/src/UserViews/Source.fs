...
type SourceUserView = { AllowBroken: bool; Query: string }

type SourceUserViewsGeneratorScript = { Script: string; AllowBroken: bool }
...
let emptySourceUserViews: SourceUserViews = { Schemas = Map.empty }
