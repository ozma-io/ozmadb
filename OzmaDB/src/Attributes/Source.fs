module OzmaDB.Attributes.Source
...
let emptySourceAttributesEntity: SourceAttributesEntity = { Fields = Map.empty }
...
let mergeSourceAttributesDatabase
    (a: SourceAttributesDatabase)
    (b: SourceAttributesDatabase)
    : SourceAttributesDatabase =
...
let emptySourceDefaultAttributes: SourceDefaultAttributes = { Schemas = Map.empty }
