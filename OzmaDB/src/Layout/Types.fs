...
let parseTypeName (root : ResolvedEntityRef) (typeName : string) : ResolvedEntityRef =
    ...
    | [| entityName |] -> { root with Name = OzmaQLName entityName }
    | [| schemaName; entityName |] -> { Schema = OzmaQLName schemaName; Name = OzmaQLName entityName }
...
let schemasNameFieldRef : ResolvedFieldRef = { Entity = { Schema = funSchema; Name = OzmaQLName "schemas" }; Name = OzmaQLName "name" }
